...
public class CreateCustomerCommand {
    @NotBlank(message = "Mã khách hàng không được để trống") @Size(max = 20) private String code;
    @NotBlank(message = "Tên khách hàng không được để trống") @Size(max = 100) private String name;
