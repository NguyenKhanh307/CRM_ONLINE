...
public class ServiceBeanConfig {
    ...
    @Bean public ListTicketCommentUseCase listTicketCommentUseCase(ITicketCommentRepository r, vn.com.be_crm.core.lookup.port.INameResolver n) { return new ListTicketCommentUseCase(r, n); }
