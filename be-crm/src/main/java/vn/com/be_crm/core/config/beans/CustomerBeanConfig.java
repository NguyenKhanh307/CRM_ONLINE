...
public class CustomerBeanConfig {
    ...
    @Bean public GetCustomerUseCase getCustomerUseCase(ICustomerRepository r, vn.com.be_crm.core.lookup.port.INameResolver n) { return new GetCustomerUseCase(r, n); }
