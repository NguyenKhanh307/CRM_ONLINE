...
public class PricingBeanConfig {
    ...
    /** @return ListEligiblePricePolicyUseCase — danh sách chính sách hợp lệ cho form (lọc theo nhân viên/khách hàng) */
    @Bean public ListEligiblePricePolicyUseCase listEligiblePricePolicyUseCase(
            IPricePolicyRepository r, IPricePolicyEmployeeRepository employeeRepo, IPricePolicyCustomerRepository customerRepo) {
        return new ListEligiblePricePolicyUseCase(r, employeeRepo, customerRepo);
    }
    ...
    /** @return ResolvePriceUseCase — tra cứu đơn giá theo chính sách giá, có kiểm tra quyền sử dụng */
    @Bean public vn.com.be_crm.application.pricing.query.ResolvePriceUseCase resolvePriceUseCase(
            IPricePolicyProductRepository r, IPricePolicyEmployeeRepository employeeRepo, IPricePolicyCustomerRepository customerRepo) {
        return new vn.com.be_crm.application.pricing.query.ResolvePriceUseCase(r, employeeRepo, customerRepo);
    }
