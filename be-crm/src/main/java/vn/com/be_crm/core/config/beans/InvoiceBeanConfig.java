...
public class InvoiceBeanConfig {
    ...
    @Bean public GetInvoiceUseCase getInvoiceUseCase(IInvoiceRepository r, vn.com.be_crm.core.lookup.port.INameResolver n) { return new GetInvoiceUseCase(r, n); }
    /** @return ListInvoiceUseCase */
    @Bean public ListInvoiceUseCase listInvoiceUseCase(IInvoiceRepository r, vn.com.be_crm.core.lookup.port.INameResolver n) { return new ListInvoiceUseCase(r, n); }
