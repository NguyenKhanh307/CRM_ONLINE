...
public interface IInvoiceRepository {
     ...
     * @param items danh sách dòng hàng (invoiceId sẽ được gán sau khi lưu đơn hàng)
     * @return đơn hàng sau khi lưu
     */
    Invoice saveWithItems(Invoice o, List<InvoiceItem> items);
    ...
    PageResult<Invoice> findAll(PageRequest r);
