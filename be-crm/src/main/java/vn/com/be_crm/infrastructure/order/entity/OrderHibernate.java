...
public class OrderHibernate {
    ...
    @Column(name = "is_invoiced") private boolean isInvoiced;
    @Column(name = "receiver_name", length = 100) private String receiverName;
    @Column(name = "receiver_phone", length = 11) private String receiverPhone;
