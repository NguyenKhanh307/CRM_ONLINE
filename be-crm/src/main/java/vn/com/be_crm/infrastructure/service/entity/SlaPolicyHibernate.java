...
/**
 * Hibernate entity ánh xạ bảng sla_policies.
 */
@Entity
@Table(name = "sla_policies")
@Getter @Setter @NoArgsConstructor
public class SlaPolicyHibernate {
    ...
    @Enumerated(EnumType.STRING) @Column(name = "priority", nullable = false, length = 10) private TicketPriority priority;
