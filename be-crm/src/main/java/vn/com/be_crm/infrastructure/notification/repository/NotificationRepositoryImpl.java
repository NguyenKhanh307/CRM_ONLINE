...
public class NotificationRepositoryImpl implements INotificationRepository {
    ...
    @Override public Notification save(Notification n, List<Long> recipientUserIds) {
    ...
    @Override public List<NotificationFeedItem> findByRecipient(Long recipientUserId, int limit) {
