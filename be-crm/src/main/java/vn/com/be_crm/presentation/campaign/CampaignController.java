...
public class CampaignController {
    ...
    public ResponseEntity<ApiResponse<PageResponse<CampaignResult>>> list(
        ...
        // Nội dung chiến dịch marketing dùng chung cho toàn bộ nhân sự — không lọc theo owner
        // (khác các module dữ liệu khách hàng/giao dịch khác vốn giới hạn theo người phụ trách)
