...
/**
 * REST controller công khai (không cần JWT) cho khách hàng xem + phản hồi báo giá theo token.
 */
@RestController
...
public class PublicQuotationController {
    ...
    /** @param getUC lấy báo giá theo token @param respondUC ghi nhận phản hồi của khách */
    ...
    /** Khách phản hồi báo giá (accept/adjust/reject). @param token token @param body hành động + ghi chú @return 200 */
