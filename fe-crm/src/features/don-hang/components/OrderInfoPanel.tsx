...
export const OrderInfoPanel = ({ order: o }: Props) => (
    <div>
        ...
        <InfoRow label="Cơ hội" value={o.opportunityName} />
        ...
        <InfoRow label="Tiền tệ" value={o.currency} />
        ...
        <InfoRow label="Địa chỉ xuất HĐ" value={o.billingAddress} />
        <InfoRow label="Mã số thuế" value={o.taxCode} />
