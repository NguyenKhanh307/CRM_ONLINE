...
import { badgeCell, dateCell, labelCell, numberCell, textCell } from '@/shared/components/table/cells';
...
export const getActivityColumns = (): ColumnDef<ActivityResult>[] => [
    ...
    { accessorKey: 'callDuration', header: 'Thời lượng (phút)', size: 120, cell: numberCell },
